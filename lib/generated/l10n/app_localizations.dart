...
abstract class AppLocalizations {
  ...
  /// The application name for development
  ///
  /// In en, this message translates to:
  /// **'Flutter Base Project Dev'**
  String get appNameDev;

  /// The application name for staging
  ///
  /// In en, this message translates to:
  /// **'Flutter Base Project Staging'**
  ...
  /// Is development mode label
  ///
  /// In en, this message translates to:
  /// **'Is Development'**
  String get isDevelopment;

  /// Is staging mode label
  ///
  /// In en, this message translates to:
  /// **'Is Staging'**
  String get isStaging;

  /// Is production mode label
  ///
  /// In en, this message translates to:
  /// **'Is Production'**
